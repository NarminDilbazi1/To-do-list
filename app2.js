...
document.querySelector(".sort img").addEventListener("mouseleave", event => {
  if (event.target.classList.contains("reverse")) {
    event.target.src = "./svg/Group 90.svg";
  }
  else {
    event.target.src = "./svg/Group 74.svg";
  }
})

document.querySelector(".sort img").addEventListener("mouseover", event => {
  if (event.target.classList.contains("reverse")) {
    event.target.src = "./svg/Group 91.svg";
  }
  else {
    event.target.src = "./svg/Group 73.svg";
  }
})
sortBtn.addEventListener("click", () => {
  if (sortBtn.classList.contains("reverse")) {
    tasks.reverse();
    sortBtn.src = "./svg/Group 73.svg";
  } else {
    tasks.sort();
    sortBtn.src = "./svg/Group 74.svg";
  }
